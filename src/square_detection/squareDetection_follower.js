/*
   ...
   for a square follower with basic people avoidance.
   */
...
var LOWER_THRESHOLD = [0,100, 90];
var UPPER_THRESHOLD = [10,255, 255];
var LOWER_THRESHOLD1 = [160, 160, 90];
...
squareDetection.prototype.detect = function(im){
	...
	for(var i=0; i<contours.size();i++){
		...
		//console.log('Area: %d, NbVertices: %d \n', contours.area(i),contours.cornerCount(i));
